## 해결하고자 한 문제
사용하는 MCP가 늘어나면서 MCP를 항상켜놓으면 잘못된 MCP를 사용하거나 일부 상황에서만 쓰는 MCP가 관리가 불편한 케이스가 존재함. 이럴 때 수동으로 MCP설정에 추가/삭제하는 것에 대한 부담이 있음.
...
## 💰 도네이션
잘 쓰시고 계신다면 레포에 하트 부탁드립니다.
개발자한테 1000원 주시면 카페인 먹으면서 열심히 개선하겠습니다 ㅎㅎ 
<img width="1080" height="1214" alt="개발자한테 1000원주기" src="https://github.com/user-attachments/assets/4b7143c5-ea85-45f4-bd8b-62f09a2c0da5" />
